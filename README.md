...
1. **Add library code** to `library/src/main/java/es/joshluq/foundationkit/`
2. **Write unit tests** in `library/src/test/java/es/joshluq/foundationkit/`
3. **Write instrumented tests** in `library/src/androidTest/java/es/joshluq/foundationkit/`
4. **Integrate the library** in the showcase app at `showcase/src/main/java/es.joshluq.foundationkit/showcase/` to validate the consumer experience
5. **Add showcase tests** in `showcase/src/test/java/es.joshluq.foundationkit/showcase/` or `showcase/src/androidTest/java/es.joshluq.foundationkit/showcase/`
